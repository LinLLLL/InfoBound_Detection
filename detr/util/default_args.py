...
def get_args_parser():
    ...
    parser.add_argument('--mm_loss_coef', default=4, type=float)

    # dataset parameters
    parser.add_argument('--dataset_file', default='coco')
    parser.add_argument('--ood_data', default='coco')
    ...
    parser.add_argument('--mixture_ood', default=False, action='store_true',
                        help='if True, then also use the unlabeled covariate-shifted ood data')
    parser.add_argument('--mm_energy', default=True, help='use the IRL regularization to improve ood aware')
    parser.add_argument('--evaluate_mode', default='id', type=str, choices=['id', 'ood'], help='which data to evaluate on')
